...
3. download the `Models` file and upload it to the designated drive .
4. Execute the notebook cells to preprocess the data, train the classifier, and output the validation accuracy for the fault states.
